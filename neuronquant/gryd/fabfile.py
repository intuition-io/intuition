...
#FIXME HARD CODED
ENGINES_PATH = os.path.expanduser(
    '~/.config/ipython/profile_default/security/ipcontroller-engine.json')
NODE_PATH = os.path.expanduser("~/.nvm/v0.10.7/lib/node_modules")
NODE_CONFIG = os.path.expanduser("~/.quantrade")
RESTSERVER_PATH = os.path.expanduser(
    '~/dev/projects/labo/nodeserver/rest_server.js')
