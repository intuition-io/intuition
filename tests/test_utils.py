...
class ConfigurationTestCase(unittest.TestCase):
    ...
    def test_build_date_index(self):
        ...
        self._validate_dates_index(utils.build_date_index(start='2011/01/01'))
        self._validate_dates_index(utils.build_date_index(end='2014/01/01'))
        self._validate_dates_index(
            utils.build_date_index(end='2014/01/01', freq='M'))
        self._validate_dates_index(
            utils.build_date_index(start='2011', end='2014/01/01'))
