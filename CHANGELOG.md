 ...
 * pre-revival
 * notice, Shiny config FIX
 * Licences update and FIX, tmp clean directories
 * FIX and typos
 * idem + R installation and fixes
 * Install and readme improvements
 * General installation paradigm and improvements
 * dokku and travis compliant
 * Installation easier, vagrant use
 * zipline wrapper, travis tests
 * update
 * Updated zipline
 * Fixed dates issue and forex configuration
 * ...
 * database modifications
 * statsmodels and scipy out
 * automatic timezone fix
 * ...
 * ...
 * Try without pinning, and reversing order
 * ...
 * setup improvement with pip
 * Merge branch 'develop'
 * setup.py fix
 * Merge branch 'develop'
 * setup poorly fixes
 * Missing zipline/data...
 * New state fixes
 * gryd integration, end of the .quantrade directory and simplifications
 * Intermediate project split: zipline integration in neuronquant, grid computing outside
 * New cluster style
 * Generic and clean grid computing
 * intermediate backup
